...
- Runs the diabetes adjudication algorithm to define Diabetes types: Type 1, Type 2, Gestational, other, unlikely (see Figure 1)
...
source_lines("analysis/data_process.R", 30:101)
